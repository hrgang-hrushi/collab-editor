...
export default function AeyeCtaSection() {
  ...
  return (
    <section id="dispatch" className="relative w-full border-b border-[#222222] bg-[#000000] overflow-hidden scroll-mt-20">
      ...
      <div className="max-w-[1280px] mx-auto px-6 py-14 sm:py-18 relative z-10">
        {/* Section Header Meta */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between pb-4 border-b border-[#222222] text-xs font-mono mb-10">
        ...
        {/* 2-Column Side-by-Side Card */}
        <div className="border border-[#222222] bg-[#000000] p-8 sm:p-10 md:p-12 lg:p-14 max-w-5xl mx-auto rounded-none">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-8 lg:gap-12">
            {/* Left Column: Meta, Title & Copy */}
            <div className="flex-1 max-w-xl space-y-3">
              ...
              <h3 className="text-2xl sm:text-3xl lg:text-[34px] font-normal tracking-tight text-white font-sans leading-tight">
            ...
            {/* Right Column: Form or CallChip Status */}
            <div className="w-full md:w-auto md:min-w-[340px] lg:min-w-[400px] shrink-0">
              {chipStage !== "idle" ? (
                <motion.div
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#0e0e11] border border-[#333333] hover:border-white text-white font-sans text-xs tracking-wider uppercase hover:bg-white hover:text-black transition-none cursor-pointer rounded-none font-medium shrink-0 group"
                  >
