...
description: >-
  Strict Bare-Metal Hardware Brutalism design system and DOM kernel specification for Crex / Crux IDE.
  Enforces 0px border radius, monochrome palette (#000000, #FFFFFF, #111111, #222222, #444444),
  the Typographic Engine (Etna / Space Grotesk brand, Arial MT Pro / Hanken Grotesk UI, Geist / JetBrains Mono execution canvas),
  flush 1px dividers, spinny blur void motion effects, and strict prohibition of gradients, drop shadows,
  and rounded corners. Use whenever styling, creating, or modifying UI components, layouts, pages, or DOM elements in Crux / Crex.
---
